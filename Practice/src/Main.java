...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Creating a boolean in order to return if a string has an int using this for
		// loop
		...
		System.out.println(scoreReporter(score));
	...
	public static String isEvenOrOdd(int score) {
		...
		// If an int unevenly divides with another int, the value will lose precision,
		// but if the calculation includes a double, it will be accurate
		if (score / 2 == score / (double) 2) {
			return "even!";
		}
	...
	public static String scoreReporter(int score) {
